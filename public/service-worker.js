const CACHE_NAME = "ws2000-v1.9.2";
const STATIC_ASSETS = ["/", "/index.html", "/styles.css?v=1.9.2", "/history-time.js?v=1.9.2", "/insights.js?v=1.9.2", "/forecast.js?v=1.9.2", "/app.js?v=1.9.2", "/manifest.webmanifest", "/icon.svg"];
