const CACHE_NAME = "ws2000-v1.9.1";
const STATIC_ASSETS = ["/", "/index.html", "/styles.css?v=1.9.1", "/history-time.js?v=1.9.1", "/insights.js?v=1.9.1", "/forecast.js?v=1.9.1", "/app.js?v=1.9.1", "/manifest.webmanifest", "/icon.svg"];
